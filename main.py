...
PTmoon = shipPart("moon", 200, 200, 4, getImg("parts/Tmoon"))
...
fire2 = Prompt("fire2", ["Your money is low, and you are losing more.", "You need a way to stop your money"], [Result("Why don't we just hire more campaigners?", "After putting out a hasty ad campaign:", [["addcam", 2], ["addmoney", -3.2], ["overtime", -.3]]), Result("How about we reduce costs?", "After using less expensive materials:", [["reduce", 1]]), Result("Why not just reduce the work hours?", "You reduce the work hours.", [["addTime", -.2], ["addflav", "Your workers are more well rested at work."]])], 10)
